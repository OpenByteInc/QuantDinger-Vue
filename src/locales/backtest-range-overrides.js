const common = {
  'backtest-center.quickRange.label': 'Quick range',
  'backtest-center.quickRange.1m': '1 month',
...
export default {
  'en-US': common,
  'zh-CN': {
    'backtest-center.quickRange.label': '快捷区间',
    'backtest-center.quickRange.1m': '1个月',
  ...
  'zh-TW': {
    'backtest-center.quickRange.label': '快捷區間',
    'backtest-center.quickRange.1m': '1個月',
  ...
  'de-DE': {
    'backtest-center.quickRange.label': 'Schnellbereich',
    'backtest-center.quickRange.1m': '1 Monat',
  ...
  'fr-FR': {
    'backtest-center.quickRange.label': 'Période rapide',
    'backtest-center.quickRange.1m': '1 mois',
  ...
  'ja-JP': {
    'backtest-center.quickRange.label': 'クイック期間',
    'backtest-center.quickRange.1m': '1か月',
  ...
  'ko-KR': {
    'backtest-center.quickRange.label': '빠른 기간',
    'backtest-center.quickRange.1m': '1개월',
  ...
  'ru-RU': {
    'backtest-center.quickRange.label': 'Быстрый период',
    'backtest-center.quickRange.1m': '1 месяц',
  ...
  'th-TH': {
    'backtest-center.quickRange.label': 'ช่วงด่วน',
    'backtest-center.quickRange.1m': '1 เดือน',
  ...
  'vi-VN': {
    'backtest-center.quickRange.label': 'Khoảng nhanh',
    'backtest-center.quickRange.1m': '1 tháng',
  ...
  'ar-SA': {
    'backtest-center.quickRange.label': 'نطاق سريع',
    'backtest-center.quickRange.1m': 'شهر واحد',
