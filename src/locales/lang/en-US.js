...
const locale = {
  ...
  'trading-assistant.template.maCrossover': 'MA Crossover',
  'trading-assistant.template.maCrossoverDesc': 'Classic dual moving average crossover. Buy when fast MA crosses above slow MA, sell when it crosses below.',
  'trading-assistant.template.rsiOversold': 'RSI Oversold Bounce',
  'trading-assistant.template.rsiOversoldDesc': 'Enter long when RSI bounces from oversold territory. Exit when RSI reaches overbought.',
  'trading-assistant.template.bollingerSqueeze': 'Bollinger Band Squeeze Breakout',
  'trading-assistant.template.bollingerSqueezeDesc': 'Trade breakouts after Bollinger Band squeezes. Long on upper band breakout.',
  'trading-assistant.template.macdDivergence': 'MACD Divergence',
  'trading-assistant.template.macdDivergenceDesc': 'Enter long on bullish MACD divergence (price makes lower low but MACD doesn\'t).',
  'trading-assistant.template.breakoutVolume': 'Volume Breakout',
  'trading-assistant.template.breakoutVolumeDesc': 'Enter when price breaks above recent high with above-average volume. ATR-based stop loss.',
  'trading-assistant.template.meanReversionBB': 'BB Mean Reversion',
  'trading-assistant.template.meanReversionBBDesc': 'Buy when price touches lower Bollinger Band, sell at upper band. Best for ranging markets.',
  'trading-assistant.template.turtleTrading': 'Turtle Trading',
  'trading-assistant.template.turtleTradingDesc': 'Classic trend following. Enter on 20-day high breakout, exit on 10-day low. ATR-based position sizing.',
  'trading-assistant.template.pairsTrading': 'Pairs Trading',
  'trading-assistant.template.pairsTradingDesc': 'Trade the spread between an asset and its mean. Long when spread diverges, exit when spread reverts.',
  'trading-assistant.template.momentumRotation': 'Momentum Rotation',
  'trading-assistant.template.momentumRotationDesc': 'Rank assets by momentum score periodically. Hold positive momentum and rebalance.',
  ...
  'trading-assistant.templateParam.fast_period.label': 'Fast Period',
  'trading-assistant.templateParam.fast_period.desc': 'Period for the fast moving average or EMA.',
  'trading-assistant.templateParam.slow_period.label': 'Slow Period',
  'trading-assistant.templateParam.slow_period.desc': 'Period for the slow moving average or EMA.',
  'trading-assistant.templateParam.position_pct.label': 'Position Size',
  'trading-assistant.templateParam.position_pct.desc': 'Portion of total equity to allocate to this trade.',
  'trading-assistant.templateParam.rsi_period.label': 'RSI Period',
  'trading-assistant.templateParam.rsi_period.desc': 'Period for computing the Relative Strength Index (RSI).',
  'trading-assistant.templateParam.oversold.label': 'Oversold Level',
  'trading-assistant.templateParam.oversold.desc': 'RSI boundary below which the asset is considered oversold.',
  'trading-assistant.templateParam.overbought.label': 'Overbought Level',
  'trading-assistant.templateParam.overbought.desc': 'RSI boundary above which the asset is considered overbought.',
  'trading-assistant.templateParam.bb_period.label': 'BB Period',
  'trading-assistant.templateParam.bb_period.desc': 'Period for the middle Bollinger Band moving average.',
  'trading-assistant.templateParam.bb_std.label': 'BB Std Dev',
  'trading-assistant.templateParam.bb_std.desc': 'Standard deviation multiplier for the Bollinger Bands width.',
  'trading-assistant.templateParam.squeeze_threshold.label': 'Squeeze Threshold',
  'trading-assistant.templateParam.squeeze_threshold.desc': 'Bandwidth threshold below which the band squeeze is active.',
  'trading-assistant.templateParam.signal_period.label': 'Signal Period',
  'trading-assistant.templateParam.signal_period.desc': 'Period for the MACD signal line (EMA of MACD line).',
  'trading-assistant.templateParam.lookback.label': 'Lookback Period',
  'trading-assistant.templateParam.lookback.desc': 'Number of prior bars to look back for price extremes or stats.',
  'trading-assistant.templateParam.volume_multiplier.label': 'Volume Multiplier',
  'trading-assistant.templateParam.volume_multiplier.desc': 'Multiplier for the average volume to detect breakout volume.',
  'trading-assistant.templateParam.atr_multiplier.label': 'ATR Multiplier',
  'trading-assistant.templateParam.atr_multiplier.desc': 'Multiplier of the Average True Range (ATR) used for stop loss.',
  'trading-assistant.templateParam.entry_period.label': 'Entry Breakout Period',
  'trading-assistant.templateParam.entry_period.desc': 'Lookback period for the entry breakout high.',
  'trading-assistant.templateParam.exit_period.label': 'Exit Breakdown Period',
  'trading-assistant.templateParam.exit_period.desc': 'Lookback period for the exit breakdown low.',
  'trading-assistant.templateParam.atr_period.label': 'ATR Period',
  'trading-assistant.templateParam.atr_period.desc': 'Period for computing the Average True Range (ATR).',
  'trading-assistant.templateParam.risk_per_trade.label': 'Risk Per Trade',
  'trading-assistant.templateParam.risk_per_trade.desc': 'Percentage of total equity to risk on a single trade.',
  'trading-assistant.templateParam.symbol_a.label': 'Asset A',
  'trading-assistant.templateParam.symbol_a.desc': 'Asset A in pairs trading.',
  'trading-assistant.templateParam.symbol_b.label': 'Asset B',
  'trading-assistant.templateParam.symbol_b.desc': 'Asset B in pairs trading.',
  'trading-assistant.templateParam.entry_zscore.label': 'Entry Z-Score',
  'trading-assistant.templateParam.entry_zscore.desc': 'Standard deviation threshold of spread divergence to trigger entry.',
  'trading-assistant.templateParam.exit_zscore.label': 'Exit Z-Score',
  'trading-assistant.templateParam.exit_zscore.desc': 'Standard deviation threshold of spread reversion to trigger exit.',
  'trading-assistant.templateParam.universe_size.label': 'Universe Size',
  'trading-assistant.templateParam.universe_size.desc': 'Number of assets monitored in the rotation pool.',
  'trading-assistant.templateParam.hold_count.label': 'Hold Count',
  'trading-assistant.templateParam.hold_count.desc': 'Number of top-ranking assets to buy and hold.',
  'trading-assistant.templateParam.momentum_period.label': 'Momentum Period',
  'trading-assistant.templateParam.momentum_period.desc': 'Lookback period for evaluating momentum performance.',
  'trading-assistant.templateParam.rebalance_interval.label': 'Rebalance Interval',
  'trading-assistant.templateParam.rebalance_interval.desc': 'Check interval (in bars) for rebalancing the portfolio.',
