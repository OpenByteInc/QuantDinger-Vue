...
const locale = {
  ...
  "settings.field.LLM_MAX_TOKENS": "Max Tokens",
  ...
  "indicatorIde.marketPicker.open": "Add from Market",
  "indicatorIde.marketPicker.title": "Add indicators",
  "indicatorIde.marketPicker.subtitle": "Browse chart indicators from the Market. Strategies are excluded.",
  "indicatorIde.marketPicker.resultCount": "{count} indicators",
  "indicatorIde.marketPicker.empty": "No matching indicators",
  "indicatorIde.marketPicker.added": "Added",
  "indicatorIde.marketPicker.communityAuthor": "Community creator",
  ...
  "settings.desc.ADMIN_USER": "Bootstrap username for a new installation and legacy single-user mode. Change an existing account in User Management.",
  "settings.desc.ADMIN_PASSWORD": "Bootstrap password for a new installation and legacy single-user mode. Change an existing account password in the account settings.",
  ...
  "settings.desc.LLM_MAX_TOKENS": "Maximum output tokens per request",
...
export default {
  ...
  "strategyIde.marketPickerOpen": "Add strategy from Market",
  "strategyIde.marketPicker.title": "Add market strategies",
  "strategyIde.marketPicker.subtitle": "Get an editable strategy template and continue in the matching strategy workspace.",
  "strategyIde.marketPicker.resultCount": "{count} strategies",
  "strategyIde.marketPicker.empty": "No matching strategies",
  "strategyIde.marketPicker.edit": "Edit",
  "strategyIde.marketPicker.cta": "CTA strategies",
  "strategyIde.marketPicker.portfolio": "Portfolio strategies",
  "strategyIde.marketPicker.ctaShort": "CTA",
  "strategyIde.marketPicker.portfolioShort": "Portfolio",
  "strategyIde.marketPicker.samples": "{count} backtests",
  "strategyIde.marketPicker.noBacktestData": "No valid backtest data",
  "strategyIde.marketPicker.selectorHint": "Click a strategy name to load it into this workspace",
  "strategyIde.marketPicker.noLocalStrategies": "No local strategies in this category",
  ...
  "settings.field.AI_DECISION_TIMEOUT_SECONDS": "AI decision timeout (seconds)",
  "settings.desc.AI_DECISION_TIMEOUT_SECONDS": "Maximum time for the pre-trade AI decision filter. Valid runtime values are clamped to 1–30 seconds.",
  "settings.field.TRONGRID_BASE_URL": "TronGrid base URL",
  "settings.desc.TRONGRID_BASE_URL": "Override the TronGrid API endpoint used for TRC20 payment reconciliation.",
  "settings.field.ETHERSCAN_V2_BASE_URL": "Etherscan V2 base URL",
  "settings.desc.ETHERSCAN_V2_BASE_URL": "Override the Etherscan V2 endpoint used for EVM payment reconciliation.",
  "settings.field.ETH_RPC_URLS": "Ethereum RPC URLs",
  "settings.desc.ETH_RPC_URLS": "Optional comma-separated Ethereum JSON-RPC endpoints used as ERC20 reconciliation fallbacks.",
  "settings.field.SOLANA_RPC_URL": "Solana RPC URL",
  "settings.desc.SOLANA_RPC_URL": "Solana JSON-RPC endpoint used for SPL-token payment reconciliation.",
  "settings.field.BEP20_PREFER_EXPLORER": "Prefer explorer for BEP20",
  "settings.desc.BEP20_PREFER_EXPLORER": "Use Etherscan V2 explorer queries before BSC RPC. This usually requires a paid Etherscan plan for BSC.",
  "settings.field.ERC20_PREFER_EXPLORER": "Prefer explorer for ERC20",
  "settings.desc.ERC20_PREFER_EXPLORER": "Use Etherscan V2 explorer queries before Ethereum RPC for ERC20 reconciliation.",
  "settings.field.USDT_AMOUNT_SUFFIX_DECIMALS": "Payment suffix decimals",
  "settings.desc.USDT_AMOUNT_SUFFIX_DECIMALS": "Decimal places reserved for unique payment amount suffixes. Runtime accepts 4–8."
}
