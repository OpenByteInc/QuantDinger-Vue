...
const locale = {
  ...
  'trading-assistant.table.noPositions': '无持仓',
  'trading-assistant.table.summary': '合计统计',
  ...
  'trading-assistant.template.maCrossover': '均线交叉策略',
  'trading-assistant.template.maCrossoverDesc': '经典双均线交叉策略，快线上穿慢线做多，下穿做空。',
  'trading-assistant.template.rsiOversold': 'RSI 超卖反弹',
  'trading-assistant.template.rsiOversoldDesc': '当 RSI 跌破超卖线后回升时入场做多，RSI 超买时平仓。',
  'trading-assistant.template.bollingerSqueeze': '布林带收缩突破',
  'trading-assistant.template.bollingerSqueezeDesc': '布林带收缩后突破上轨做多，利用波动率爆发行情。',
  'trading-assistant.template.macdDivergence': 'MACD 背离策略',
  'trading-assistant.template.macdDivergenceDesc': '价格创新低但 MACD 未创新低（底背离）时做多。',
  'trading-assistant.template.breakoutVolume': '放量突破',
  'trading-assistant.template.breakoutVolumeDesc': '当价格突破近期高点且成交量放大时入场，结合 ATR 追踪止损。',
  'trading-assistant.template.meanReversionBB': '布林带均值回归',
  'trading-assistant.template.meanReversionBBDesc': '价格触碰布林带下轨时做多，触碰上轨时平仓。',
  'trading-assistant.template.turtleTrading': '海龟交易法',
  'trading-assistant.template.turtleTradingDesc': '经典趋势跟踪策略，突破 20 日高点入场，跌破 10 日低点出场，结合 ATR 仓位管理。',
  'trading-assistant.template.pairsTrading': '配对交易',
  'trading-assistant.template.pairsTradingDesc': '监测资产与均值的偏差，在偏离达到阈值时做多，回归时平仓。',
  'trading-assistant.template.momentumRotation': '动量轮动',
  'trading-assistant.template.momentumRotationDesc': '定期评估资产的动量得分，保持在动量为正的资产中，定期再平衡。',
  ...
  'trading-assistant.templateParam.fast_period.label': '快线周期',
  'trading-assistant.templateParam.fast_period.desc': '快速均线或快速 EMA 的计算周期。',
  'trading-assistant.templateParam.slow_period.label': '慢线周期',
  'trading-assistant.templateParam.slow_period.desc': '慢速均线或慢速 EMA 的计算周期。',
  'trading-assistant.templateParam.position_pct.label': '仓位比例',
  'trading-assistant.templateParam.position_pct.desc': '单次交易投入的账户权益比例。',
  'trading-assistant.templateParam.rsi_period.label': 'RSI 周期',
  'trading-assistant.templateParam.rsi_period.desc': '相对强弱指标 (RSI) 的计算周期。',
  'trading-assistant.templateParam.oversold.label': '超卖线',
  'trading-assistant.templateParam.oversold.desc': 'RSI 判定超卖的数值边界，低于该值视为超卖。',
  'trading-assistant.templateParam.overbought.label': '超买线',
  'trading-assistant.templateParam.overbought.desc': 'RSI 判定超买的数值边界，高于该值视为超买。',
  'trading-assistant.templateParam.bb_period.label': '布林带周期',
  'trading-assistant.templateParam.bb_period.desc': '布林带中轨移动平均线的计算周期。',
  'trading-assistant.templateParam.bb_std.label': '布林带标准差',
  'trading-assistant.templateParam.bb_std.desc': '布林带上下轨相对于中轨的偏差标准差倍数。',
  'trading-assistant.templateParam.squeeze_threshold.label': '收缩阈值',
  'trading-assistant.templateParam.squeeze_threshold.desc': '带宽（上下轨差值除以中轨）低于此值判定为收缩，预示即将突破。',
  'trading-assistant.templateParam.signal_period.label': '信号线周期',
  'trading-assistant.templateParam.signal_period.desc': 'MACD 信号线（MACD 线的 EMA）计算周期。',
  'trading-assistant.templateParam.lookback.label': '回溯周期',
  'trading-assistant.templateParam.lookback.desc': '寻找历史价格极值或计算均值的回溯 K 线数量。',
  'trading-assistant.templateParam.volume_multiplier.label': '放量倍数',
  'trading-assistant.templateParam.volume_multiplier.desc': '当前成交量相比于近期平均成交量的倍数，超过此值视为放量。',
  'trading-assistant.templateParam.atr_multiplier.label': 'ATR 倍数',
  'trading-assistant.templateParam.atr_multiplier.desc': '以真实波幅均值 (ATR) 的多少倍设置止损。',
  'trading-assistant.templateParam.entry_period.label': '入场突破周期',
  'trading-assistant.templateParam.entry_period.desc': '计算最高点用于买入突破的回溯 K 线周期。',
  'trading-assistant.templateParam.exit_period.label': '出场跌破周期',
  'trading-assistant.templateParam.exit_period.desc': '计算最低点用于卖出出场的回溯 K 线周期。',
  'trading-assistant.templateParam.atr_period.label': 'ATR 周期',
  'trading-assistant.templateParam.atr_period.desc': '计算真实波幅均值 (ATR) 的 K 线周期。',
  'trading-assistant.templateParam.risk_per_trade.label': '单笔风险',
  'trading-assistant.templateParam.risk_per_trade.desc': '单笔交易亏损占账户总权益的最大风险比例。',
  'trading-assistant.templateParam.symbol_a.label': '交易标的 A',
  'trading-assistant.templateParam.symbol_a.desc': '配对交易中的标的资产 A。',
  'trading-assistant.templateParam.symbol_b.label': '交易标的 B',
  'trading-assistant.templateParam.symbol_b.desc': '配对交易中的标的资产 B。',
  'trading-assistant.templateParam.entry_zscore.label': '入场 Z 分数',
  'trading-assistant.templateParam.entry_zscore.desc': '价差偏离均值的标准差倍数，超过该值触发交易。',
  'trading-assistant.templateParam.exit_zscore.label': '出场 Z 分数',
  'trading-assistant.templateParam.exit_zscore.desc': '价差回归到多少倍标准差以内时平仓。',
  'trading-assistant.templateParam.universe_size.label': '资产池大小',
  'trading-assistant.templateParam.universe_size.desc': '动量轮动监控的候选资产池数量。',
  'trading-assistant.templateParam.hold_count.label': '持仓数量',
  'trading-assistant.templateParam.hold_count.desc': '动量排名前多少位的资产会被买入持有。',
  'trading-assistant.templateParam.momentum_period.label': '动量计算周期',
  'trading-assistant.templateParam.momentum_period.desc': '评估动量表现（如变动率 ROC）的回溯周期。',
  'trading-assistant.templateParam.rebalance_interval.label': '再平衡周期',
  'trading-assistant.templateParam.rebalance_interval.desc': '策略调整持仓的检查周期（K 线数量）。',
